...
#define STRING_CONFIG_H_AUTHOR "(Dylan Haskins)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anet A8 Hemara/BLTouch"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -22, -64, 0 }
